    ...
    <div class="login-box">
      ...
      <div class="message-container">
        <p
          ...
          :class="error ? 'error-msg' : 'success-msg'"
        >
          {{ error || success }}
        </p>
      </div>
      ...
      <div class="password-wrapper input-wrapper input-wrapper2">
        <input
      ...
      <button
        type="submit"
        class="login-btn rotating-border"
        @click="loginHandler"
      >
        Login
      </button>
    ...
    <div class="modal-overlay" v-if="showResetPopup">
      <div class="reset-popup-card">
        ...
        <div class="popup-buttons">
          <button @click="sendResetEmail" class="reset-btn reset-btn-send">
            Send
          </button>
    ...
    methods: {
      ...
      async loginHandler() {
        ...
        if (
          ...
          this.error = "Enter proper login credentials.";
          return;
        }
