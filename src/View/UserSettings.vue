  ...
  <div class="app-container scroll">
    <div class="settings-content">
      ...
      <section class="account-settings">
        ...
        <ul>
          <li>
            <SettingOptions
              :optionType="'password'"
              :leftIconPath="require('@/assets/key.svg')"
              :leftIconAttr="'key'"
              ...
              @saveFields="({ type, value }) => saveForm(type, value)"
          ...
          <li>
            <SettingOptions
              :optionType="'email'"
              :leftIconPath="require('@/assets/mail.svg')"
              :leftIconAttr="'mail'"
              :label="'Change Email'"
              :inputFieldList="[
          ...
          <li>
            <SettingOptions
              :optionType="'Phone'"
              :leftIconPath="require('@/assets/phone.svg')"
              :leftIconAttr="'phone'"
      ...
      <section class="notifications">
        ...
        <NotificationOptions
          :leftIcon="require('@/assets/bell.svg')"
          :leftIconAlt="'bell'"
          :label_name="'Weekly Summary'"
        />

        <NotificationOptions
          :leftIcon="require('@/assets/alert.svg')"
          :leftIconAlt="'alert'"
          :label_name="'Budget Alerts'"
        />

        <NotificationOptions
          :leftIcon="require('@/assets/bill.svg')"
          :leftIconAlt="'bill'"
          :label_name="'Bill Reminders'"
        />
      </section>
      ...
      <section class="support">
        ...
        <ul class="details">
          <li>+91 4567880000</li>
          <li>
            <a href="#" class="email-address">admin@gmail.com</a>
          </li>
        </ul>
      </section>
    </div>
  ...
  methods: {
    ...
    async saveForm(type, values) {
      ...
      try {
        ...
        switch (type) {
          case "password": {
            const [currentPassword, newPassword, confirmPassword] = values.map(
              v => v?.trim() || ""
            );
          ...
          case "email": {
            ...
            if (user.email !== currentEmail) {
              this.showPopup(
                "Current email doesn't match your profile.",
                "error"
              );
              return;
            }
          ...
          case "phone": {
            this.showPopup(
              "Phone number update logic not implemented.",
              "error"
            );
