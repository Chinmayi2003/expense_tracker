        ...
        <table>
            ...
            >
              ...
              <div class="action-icon">
                <img
                  ...
                  :class="action.class"
                  @click="
                    action.name === 'delete' ? confirmDelete(index) : null
                  "
                />
              </div>
            </tr>
          ...
          <tbody v-else>
            <tr class="no-data-row">
              <td colspan="6" class="no-data-cell">No data available</td>
            </tr>
          </tbody>
        </table>
      </div>
...
export default {
  ...
  methods: {
    ...
    deleteTransaction() {
      this.$store.dispatch("deleteTransaction", this.deleteIndex);
